...
export function useXstateActor<TActor extends ActorRef<any, any>>(
...
export function useXstateActor<TEvent extends EventObject, TEmitted>(
...
export function useXstateActor(
  actorRef:
