...
func init() {
	m.Register(func(db dbx.Builder) error {
		...
		// remove
		collection.Schema.RemoveField("nyynlyzf")

		// remove
		collection.Schema.RemoveField("wzvwhour")

		// remove
		collection.Schema.RemoveField("u5fefbqy")

		// remove
		collection.Schema.RemoveField("rxfudf1e")

		// remove
		collection.Schema.RemoveField("mzud8avp")

		// remove
		collection.Schema.RemoveField("pcw7bggo")

		// remove
		collection.Schema.RemoveField("ze43sjbu")
