...
func init() {
	m.Register(func(db dbx.Builder) error {
		...
		// remove
		collection.Schema.RemoveField("x91tyczl")

		// remove
		collection.Schema.RemoveField("es2dmogq")

		// remove
		collection.Schema.RemoveField("lttcxqid")

		// remove
		collection.Schema.RemoveField("vrm3cma0")

		// remove
		collection.Schema.RemoveField("znid34mf")

		// remove
		collection.Schema.RemoveField("xyzrlrb2")

		// remove
		collection.Schema.RemoveField("lyrb5bqp")

		// remove
		collection.Schema.RemoveField("wbe4cv8d")

		// remove
		collection.Schema.RemoveField("6sw36ad5")

		// remove
		collection.Schema.RemoveField("goti1cpc")

		// remove
		collection.Schema.RemoveField("jg3l4f6g")

		// remove
		collection.Schema.RemoveField("nxa6otde")
